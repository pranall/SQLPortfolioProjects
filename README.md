...
End-to-end SQL analysis of global COVID-19 data covering cases, deaths, vaccinations, trends, and population-level metrics using advanced querying techniques.
...
[Covid-19 Data Exploration using SQL full project link](https://github.com/pranall/SQLPortfolioProjects/tree/main/Covid-19%20Data%20Exploration)
...
Structured Query Language, Join Operations; Beyond Simple SELECT Queries. Core SQL principles and essential query skills used to manage and retrieve data effectively.
